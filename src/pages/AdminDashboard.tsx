...
import { Plus, BookOpen, Users, FileQuestion, BarChart3, TrendingUp, User, Settings, Building, GraduationCap, Clock, Target, Brain, Upload, Sparkles, Database, Activity, Zap, Key } from 'lucide-react';
...
const AdminDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'students' | 'questions' | 'growth' | 'subjects' | 'schools' | 'grades' | 'configs' | 'competencies' | 'performance' | 'competency-analytics' | 'sso'>(
